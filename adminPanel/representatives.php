                                    ...
                                    <table>
                                        ...
                                        for ($i = 0; $i < sizeof($results); $i++) { ?>
                                            <tr>
                                                ...
                                                <td style="padding-left: 100px;"><?php echo $results[$i][3] ?></td>
                                                <td style="padding-left: 100px;"><?php echo $results[$i][4] ?></td>
                                                <td style="padding-left: 100px;"><?php echo $results[$i][5] ?></td>
                                                <td style="padding-left: 100px;"><?php echo $results[$i][6] ?></td>
