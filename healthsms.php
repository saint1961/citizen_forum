<?php
  ...
  $sql = "SELECT * FROM `messages` WHERE `Title` = 'health'";
                                    ...
                                    <table>
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="padding-left: 200px;">Content</th>
                                                <th style="padding-left: 100px;">created_at</th>
                                        ...
                                        for ($i = 0; $i < sizeof($results); $i++) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="reply.php?id=<?php echo $results[$i][0];?>">reply</a>
                                                </td>
